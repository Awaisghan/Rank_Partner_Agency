      ...
      >
        <div className="w-full max-w-[1550px] mx-auto px-6 sm:px-10 lg:px-14 xl:px-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            {/* RIGHT COLUMN */}
            {/* ===================================================== */}
            <div className="hidden lg:flex lg:col-span-6 justify-center lg:justify-end items-center relative w-full pt-10 lg:pt-0 transform lg:scale-[0.85] xl:scale-100 lg:origin-right">
