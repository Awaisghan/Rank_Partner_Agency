          ...
          <div className="lg:col-span-5 flex flex-col space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                href="#"
                aria-label="LinkedIn"
                className="w-10 h-10 rounded-xl bg-slate-800/90 border border-slate-700/80 flex items-center justify-center text-slate-200 hover:text-white hover:bg-blue-600 hover:border-blue-500 shadow-sm hover:shadow-[0_0_12px_rgba(37,99,235,0.4)] transition-all duration-300"
              >
              ...
              <a
                href="#"
                aria-label="Facebook"
                className="w-10 h-10 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center justify-center text-slate-200 hover:text-white hover:bg-blue-600 hover:border-blue-500 shadow-sm hover:shadow-[0_0_12px_rgba(37,99,235,0.4)] transition-all duration-300"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
