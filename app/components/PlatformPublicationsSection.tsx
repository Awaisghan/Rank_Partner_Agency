        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-4 flex flex-col justify-center space-y-6">
              ...
              {/* Tagline Badge */}
              <ScrollReveal>
                <span className="text-xs font-bold tracking-[0.2em] text-[#4ade80] uppercase block">
                  THE PLATFORM
                </span>
              </ScrollReveal>
              ...
              <ScrollReveal delay={150}>
                <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] font-extrabold text-white tracking-tight leading-[1.12]">
                  Track every placement and its{" "}
                  <span className="italic font-serif font-normal text-[#4ade80] block mt-1">
                    authority
                  </span>
                </h2>
              </ScrollReveal>
              ...
              <ScrollReveal delay={250}>
                <p className="text-slate-300 text-sm sm:text-base font-normal leading-relaxed max-w-lg">
                  Domain rating, referring domains, organic traffic and live placements,
                  tracked as your campaigns run so you always know what your clients are getting.
                </p>
              </ScrollReveal>
            </div>
              ...
              <ScrollReveal delay={300}>
                <div className="w-full rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-slate-700/80 bg-white group">
                  ...
                  <div className="bg-[#111c35] px-4 sm:px-5 py-3 border-b border-slate-800 flex items-center justify-between select-none">
                    ...
                    <div className="flex items-center gap-2 bg-[#0c2a21] border border-emerald-500/40 px-3 py-1 rounded-full">
                      <span className="w-2 h-2 rounded-full bg-[#4ade80] animate-pulse shadow-[0_0_8px_#4ade80]" />
                      <span className="text-[11px] font-bold tracking-wider text-[#4ade80] uppercase">
                        TRACKING <span className="font-normal text-emerald-300 capitalize text-xs ml-1">Live placements</span>
                      </span>
                    </div>
                  </div>
