...
export default function TvGetStartedCTASection() {
  return (
        ...
        <div className="bg-[#06122e]/90 border border-slate-800/80 rounded-[32px] p-8 sm:p-12 lg:p-14 shadow-[0_25px_70px_rgba(0,0,0,0.5)] flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative overflow-hidden">
          ...
          <div className="space-y-4 max-w-2xl relative z-10">
            ...
            <ScrollReveal delay={150}>
              <h2 className="font-extrabold tracking-tight leading-tight text-white text-2xl sm:text-3xl lg:text-[38px]">
                Ready for their{" "}
                <span className="text-[#4ade80] italic font-serif font-normal">
                  close-up?
                </span>
              </h2>
            </ScrollReveal>
            ...
            <ScrollReveal delay={250}>
              <p className="text-slate-400 font-normal text-sm sm:text-base leading-relaxed">
                Share the angle and we'll book the segments that put your clients in front of the right audience.
              </p>
            </ScrollReveal>
          ...
          <ScrollReveal delay={300}>
            <div className="relative z-10 flex-shrink-0 pt-2 lg:pt-0">
              <Link
                href="#contact"
                className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-[#9ef08b] hover:bg-[#8ae476] text-[#062c19] font-extrabold text-base transition-all duration-300 shadow-[0_0_28px_rgba(158,240,139,0.35)] hover:scale-105 active:scale-95"
              >
