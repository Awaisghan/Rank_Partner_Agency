          ...
          <div className="space-y-4 max-w-2xl relative z-10">
            ...
            <ScrollReveal delay={250}>
              <p className="text-slate-400 font-normal text-sm sm:text-base leading-relaxed">
                Start with a free authority check, then let us build the links that move your clients up the search results. One flat price per placement. Links that stick.
              </p>
            </ScrollReveal>
