...
export default function TvHowItWorksSection() {
  const steps = [
    {
      num: "01",
      title: "Tell us the angle",
      desc: "Share the story, expertise and the audiences to reach.",
    },
    {
      num: "02",
      title: "We pitch producers",
      desc: "Our team books segments that fit the message and timing.",
    },
    {
      num: "03",
      title: "Prep and rehearse",
      desc: "Talking points and a run-through before your client goes on.",
    },
    {
      num: "04",
      title: "Go on air",
      desc: "Your client appears on the segment, and you keep the clip to reuse everywhere.",
    },
  ];
